...
public class Cliente extends Pessoa {
    ...
    public void incrementarLocacoes() { this.totalLocacoes++; }

    public String getNumeroCnh()                       { return numeroCnh; }
    public void setNumeroCnh(String n)                 { this.numeroCnh = n; }
    public String getCategoriaCnh()                    { return categoriaCnh; }
    public void setCategoriaCnh(String c)              { this.categoriaCnh = c; }
    public String getDataNascimento()                  { return dataNascimento; }
    public void setDataNascimento(String d)            { this.dataNascimento = d; }
    public int getTotalLocacoes()                      { return totalLocacoes; }
    public void setTotalLocacoes(int t)                { this.totalLocacoes = t; }
}
