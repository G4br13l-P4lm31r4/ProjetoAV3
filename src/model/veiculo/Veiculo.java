...
public abstract class Veiculo implements Locavel, Manutivel {
    ...
    @Override public void iniciarLocacao()  { this.disponivel = false; }
    @Override public void finalizarLocacao() { this.disponivel = true; }
    ...
    @Override public boolean necessitaManutencao()      { return this.quilometragem >= KM_MANUTENCAO; }
    @Override public double getCustoTotalManutencao()   { return this.custoTotalManutencao; }
    ...
    public void setQuilometragem(double q)     { this.quilometragem = q; }
