...
public class Carro extends Veiculo {
    ...
    @Override public double calcularValorDiaria() { return DIARIA_BASE; }

    public int getNumeroPortas()                           { return numeroPortas; }
    public void setNumeroPortas(int n)                     { this.numeroPortas = n; }
    ...
    public void setCapacidadePortaMalas(double c)          { this.capacidadePortaMalas = c; }
}
