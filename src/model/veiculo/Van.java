...
public class Van extends Veiculo {
    ...
    public double calcularValorDiaria() {
        ...
        if (capacidadePassageiros > 12) diaria *= 1.20;
        if (arCondicionado) diaria *= 1.15;
        return diaria;
    }

    public int getCapacidadePassageiros()              { return capacidadePassageiros; }
    public void setCapacidadePassageiros(int c)        { this.capacidadePassageiros = c; }
    public boolean isArCondicionado()                  { return arCondicionado; }
    public void setArCondicionado(boolean a)           { this.arCondicionado = a; }
    public String getFinalidade()                      { return finalidade; }
    public void setFinalidade(String f)                { this.finalidade = f; }
}
